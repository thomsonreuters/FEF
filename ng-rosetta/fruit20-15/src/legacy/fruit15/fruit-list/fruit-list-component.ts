...
class FruitListController {
    ...
    private static $inject = ['$scope', '$state', '$timeout', 'fruitService'];
    ...
    constructor(
        ...
        console.log('Fruit list component loaded.');
        ...
        this.gridModel.columnDefs = [
            ...
            { name: 'image_url', displayName: 'Image', width: 100,
                cellTemplate: '<img style="width:90px;height:90px;" ng-src="{{grid.getCellValue(row, col)}}" >' }
        ];

        // Apply Event Handlers.
        this.gridModel.onRegisterApi = ((gridApi) => {
    ...
    private loadDetail(fruitItemID: any) {
