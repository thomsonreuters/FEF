...
export class FruitItemDetailComponent implements angular.IComponentOptions {
    public templateUrl: string = './fruit-detail-view.html';
    ...
    constructor() {
        ...
        // Note that we need to set the bindings in the constructor in order to satisfy the bindings type<any> requirement in the angular.module.component() syntax.
